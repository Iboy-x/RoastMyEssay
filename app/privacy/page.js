    ...
    <main className="min-h-screen flex flex-col items-center justify-center p-8 bg-gradient-to-br from-dark via-dark-lighter to-dark-light text-white">
      <div className="max-w-2xl w-full bg-black/60 rounded-2xl shadow-xl p-8 backdrop-blur-md">
        ...
        <ul className="list-disc list-inside mb-4 text-lg">
          ...
          <li>We do <span className="font-bold text-primary">not</span> store your essay content unless you are logged in and submit it for roasting</li>
          <li>If you are logged in, your essays and roast results may be saved (anonymized) to help improve our AI model. These are <span className="font-bold text-primary">never shared publicly</span> or with third parties.</li>
        </ul>
        ...
        <p className="mb-4 text-lg">We use Firebase for authentication. These services may collect data as described in their own privacy policies.</p>
        <h2 className="text-2xl font-semibold mt-6 mb-2">Your Rights</h2>
        <ul className="list-disc list-inside mb-4 text-lg">
          <li>You can request deletion of your account at any time</li>
          <li>Contact us at <a href="mailto:team@roastmyessay.com" className="text-primary underline hover:text-accent">team@roastmyessay.com</a> for privacy questions</li>
        </ul>
